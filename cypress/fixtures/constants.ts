export class Constants {
  ...
  public static readonly elementsText = {
    ...
    dynamicRemotesButtonsText: ['Load App 2 Widget', 'Load App 3 Widget'],
    dynamicRemotesWidgetName: ['App 2 Widget', 'App 3 Widget'],
    dynamicRemotesSynchronousImportWidgetName: ['App 1 Widget', 'App 2 Widget'],
  };
