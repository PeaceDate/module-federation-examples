...
describe('Check Next host', () => {
  ...
  it('Check the content exist on React host', () => {
    ...
    basePage.checkElementContainText(
      baseSelectors.section,
      Constants.translation.reactRemoteTitleEn,
    );
    basePage.checkElementContainText(
      baseSelectors.section,
      Constants.translation.reactRemoteTextEn,
    );
  });
  ...
  it('Check the language is changed from Next section', () => {
    ...
    basePage.checkElementContainText(
      baseSelectors.section,
      Constants.translation.reactRemoteTitleFr,
    );
    basePage.checkElementContainText(
      baseSelectors.section,
      Constants.translation.reactRemoteTextFr,
    );
